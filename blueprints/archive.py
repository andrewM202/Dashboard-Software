...
def create_archive_collection():
    ...
    ArchiveCollectionSettings(
        ...
        header_search_input_names = [i for i in request.form['CreationCardInputNames'].split(",")],
        ...
        creationcard_input_names = [i for i in request.form['CreationCardInputNames'].split(",")],
        creationcard_input_placeholders = [i for i in request.form['CreationCardInputPlaceholders'].split(",")],
    ).save()
