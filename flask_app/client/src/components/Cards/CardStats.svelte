  ...
  <div class="flex-auto p-4">
    <div class="flex flex-wrap">
      <div
        ...
        class="relative w-full max-w-full flex-grow flex-1 max-w-[80%]"
      >
        <h5 class="truncate text-blueGray-400 uppercase font-bold text-xs">
          {statSubtitle}
        </h5>
      ...
      <div
        ...
        class="flex justify-end relative w-auto pl-4 flex-initial"
      >
        <div
    ...
    <p class="truncate text-sm text-blueGray-400 mt-4">
